...
/**
 * The persistent class for the BIGBZR_PATIA_TMESERS database table.
 * 
 */
@Entity
@Table(name="BIGBZR_PATIA_TMESERS")
@NamedQuery(name="BigbzrPatiaTmeser.findAll", query="SELECT b FROM BigbzrPatiaTmeser b")
public class BigbzrPatiaTmeser implements Serializable {
	private static final long serialVersionUID = 1L;
	
	@Id
	@SequenceGenerator(name="BigbzrPatiaTmeser_GENERATOR", sequenceName="SMART_PARK-SEQ")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="BigbzrPatiaTmeser_GENERATOR")
	@Column(name="ID")
	private long id;
