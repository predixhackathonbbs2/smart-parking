...
/**
 * The persistent class for the PLHGHT_JDVHR_TMESERS database table.
 * 
 */
@Entity
@Table(name="PLHGHT_JDVHR_TMESERS")
@NamedQuery(name="PlhghtJdvhrTmeser.findAll", query="SELECT p FROM PlhghtJdvhrTmeser p")
public class PlhghtJdvhrTmeser implements Serializable {
	private static final long serialVersionUID = 1L;
	
	@Id
	@SequenceGenerator(name="PlhghtJdvhrTmeser_GENERATOR", sequenceName="SMART_PARK-SEQ")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="PlhghtJdvhrTmeser_GENERATOR")
	@Column(name="ID")
	private long id;
